...
{
    [DbContext(typeof(VendorInvoiceDbContext))]
    partial class VendorInvoiceDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VendorInvoices.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("VendorInvoices.Entities.InvoiceLineItem", b =>
                {
            ...
            modelBuilder.Entity("VendorInvoices.Entities.PaymentTerms", b =>
                {
                    b.Property<int>("PaymentTermsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VendorInvoices.Entities.Vendor", b =>
                {
                    b.Property<int>("VendorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VendorInvoices.Entities.Invoice", b =>
                {
                    b.HasOne("VendorInvoices.Entities.PaymentTerms", "PaymentTerms")
                        .WithMany("Invoices")
                        .HasForeignKey("PaymentTermsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VendorInvoices.Entities.Vendor", "Vendor")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("VendorInvoices.Entities.InvoiceLineItem", b =>
                {
                    b.HasOne("VendorInvoices.Entities.Invoice", "Invoice")
