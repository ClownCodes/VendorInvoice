...
namespace VendorInvoice.DataAccess
{
    public class VendorInvoiceDbContext : DbContext
    {
        public VendorInvoiceDbContext(DbContextOptions<VendorInvoiceDbContext> options) : base(options) { }
